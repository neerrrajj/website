...
export default async function AddProject() {
  return (
    <div className="mt-10 text-center">
      <h1 className="font-extrabold text-4xl mb-10 text-zinc-200">
        add project
      </h1>
      <form
        action={addProject}
      ...
      >
        <input
          ...
          className="border border-zinc-600 rounded px-4 h-10 bg-black"
          required
        />
        <textarea
          name="project-description"
          placeholder="project description"
          className="border border-zinc-600 rounded px-3 py-2 bg-black"
          rows={7}
          required
        />
        <input
